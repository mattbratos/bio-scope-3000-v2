    ...
    <div className="canvas-editor">
      <div className="canvas-container">
        ...
        <div className="canvas-placeholder">
          <p>Canvas Editor</p>
          <p className="placeholder-text">Video preview and segmentation will appear here</p>
        </div>
      </div>
    </div>
  )
    ...
    <div className="app-container">
      <header className="app-header">
        ...
        <div className="app-status">
          {processingState === 'processing' && <span className="processing-badge">Processing...</span>}
        </div>
      </header>
